...
func Get_Report_Month_Export(referenceId string, conn *sqlx.DB, userID int64, role string, param map[string]any) utils.ResultFormat {
	...
	err := conn.Select(&data, query, int64(deviceId), int64(year), int64(month))
	if err != nil {
